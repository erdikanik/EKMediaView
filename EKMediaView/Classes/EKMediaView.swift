...
public protocol EKMediaViewDelegate {
    func mediaViewPageDidChange(mediaView:EKMediaView, currentMedia:EKMedia, pageIndex:Int)
}

public class EKMediaView: UIView, UIScrollViewDelegate {
    ...
    public var delegate: EKMediaViewDelegate?
